...
output_dir = Path("positive_controls_sciplex_A172")
output_dir.mkdir(parents=True, exist_ok=True)

adata = sc.read_h5ad('positive_controls/A172_qc_log1p.SE600M.merged.h5ad')
cell_types = adata.obs['cell_type_merged'].value_counts().to_csv('positive_controls_sciplex_A172/A172_merged_conc_cell_types.csv')
...
for condition in conditions:
    ...
    output_file = output_dir / (
        f"A172.Trametinib_{drug_name}.SE600M.merged.h5ad"
    )
