...
output_dir = Path("positive_controls_sciplex_U87MG")
output_dir.mkdir(parents=True, exist_ok=True)

adata = sc.read_h5ad('positive_controls/U87MG_qc_log1p.SE600M.merged.h5ad')
cell_types = adata.obs['cell_type_merged'].value_counts().to_csv('positive_controls_sciplex_U87MG/U87MG_merged_conc_cell_types.csv')
...
for condition in conditions:
    ...
    output_file = output_dir / (
        f"U87MG.Trametinib_{drug_name}.SE600M.merged.h5ad"
    )
